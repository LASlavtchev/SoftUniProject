namespace Sandbox
{
    ...
    public static class Program
    {
        public static int Main(string[] args)
        {
            ...
            {
                var dbContext = serviceScope.ServiceProvider.GetRequiredService<PlanItDbContext>();
                dbContext.Database.Migrate();
                new PlanItDbContextSeeder().SeedAsync(dbContext, serviceScope.ServiceProvider).GetAwaiter().GetResult();
            }
